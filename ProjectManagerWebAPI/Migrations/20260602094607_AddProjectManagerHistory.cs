...
{
    /// <inheritdoc />
    public partial class AddProjectManagerHistory : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FromManager = table.Column<string>(type: "TEXT", nullable: false),
                    ToManager = table.Column<string>(type: "TEXT", nullable: false),
