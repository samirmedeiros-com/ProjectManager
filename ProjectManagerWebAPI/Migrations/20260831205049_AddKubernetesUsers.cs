...
{
    /// <inheritdoc />
    public partial class AddKubernetesUsers : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "KubernetesUsers",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_KubernetesUsers", x => x.Id);
                });

            migrationBuilder.CreateIndex(
                name: "IX_KubernetesUsers_Email",
                table: "KubernetesUsers",
                column: "Email",
                unique: true);
        }
